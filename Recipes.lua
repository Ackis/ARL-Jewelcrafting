...
function module:InitializeRecipes()
	...
	recipe:SetItemFilterType("JEWELCRAFTING_MATERIALS")
	recipe:AddTrainer(5388, 15501, 18751, 18774, 19063, 19539, 19775, 19778, 26915, 26960, 26982, 26997, 28701, 33590, 33614, 33637, 33680, 44582, 46675, 47384, 47396, 47400, 47418, 47419, 47420, 47421, 47431, 48619, 49885, 52586, 52587, 52645, 52657, 57620, 65043, 65098, 85916, 86010, 93527)
	...
	recipe:SetItemFilterType("JEWELCRAFTING_RING")
	recipe:AddTrainer(5388, 15501, 18751, 18774, 19063, 19539, 19775, 19778, 26915, 26960, 26982, 26997, 28701, 33590, 33614, 33637, 33680, 44582, 46675, 49885, 52586, 52587, 52645, 52657, 65098, 85916, 86010, 93527)
	...
	recipe:AddTrainer(5388, 15501, 18751, 18774, 19063, 19539, 19775, 19778, 26915, 26997, 28701, 33590, 33614, 33637, 33680, 44582, 46675, 49885, 52586, 52587, 52645, 52657, 65098, 85916, 86010, 93527)
	...
	recipe:SetItemFilterType("JEWELCRAFTING_RING")
	recipe:AddFilters(F.CASTER, F.DPS, F.HEALER)
	recipe:AddTrainer(5388, 15501, 18751, 18774, 19063, 19539, 19775, 19778, 26915, 26960, 26982, 26997, 28701, 33590, 33614, 33637, 33680, 44582, 46675, 52586, 52587, 52645, 52657, 65098, 85916, 86010, 93527)
	...
	recipe:SetItemFilterType("JEWELCRAFTING_GEM_GREEN")
	recipe:AddFilters(F.TANK)
	recipe:AddVendor(19065, 28701, 33637, 33680, 93527)
	...
	recipe:SetItemFilterType("JEWELCRAFTING_MATERIALS")
	recipe:AddTrainer(5388, 15501, 18751, 18774, 19063, 19539, 19775, 19778, 26915, 26982, 26997, 28701, 33590, 33614, 33637, 33680, 44582, 46675, 52586, 52587, 52645, 52657, 65098, 85916, 86010, 93527)
	...
	recipe:SetItemFilterType("JEWELCRAFTING_CREATED_ITEM")
	recipe:AddTrainer(5388, 15501, 18751, 18774, 19063, 19539, 19775, 19778, 26915, 26997, 28701, 33590, 33614, 33637, 33680, 44582, 46675, 52586, 52587, 52645, 52657, 65098, 85916, 86010, 93527)
	...
	recipe:SetItemFilterType("JEWELCRAFTING_RING")
	recipe:AddFilters(F.CASTER, F.DPS, F.HEALER)
	recipe:AddTrainer(5388, 15501, 18751, 18774, 19063, 19539, 19775, 28701, 33590, 33614, 33637, 33680, 44582, 52586, 52587, 52645, 52657, 65098, 85916, 86010, 93527)
...
--	recipe:AddProfession(PROF.FISHING) Suramar --Needs updating
	...
	recipe:AddFilters(F.PRIEST)
	recipe:SetItemFilterType("JEWELCRAFTING_NECK")
	recipe:AddCustom("WATERLOGGED_CACHE", "HEROIC")
	...
	recipe:SetSkillLevels(1, 1, 780, 790, 800)
	recipe:SetCraftedItem(130243, "BIND_ON_EQUIP")
	recipe:AddFilters(F.WARRIOR, F.INSTANCE)
	recipe:SetItemFilterType("JEWELCRAFTING_NECK")
	...
	recipe:SetSkillLevels(1, 1, 780, 790, 800)
	recipe:SetCraftedItem(130244, "BIND_ON_EQUIP")
	recipe:AddFilters(F.DK, F.INSTANCE)
	recipe:SetItemFilterType("JEWELCRAFTING_NECK")
